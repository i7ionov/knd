...
},plugins:["draggable","droppable","resizable","pagination","tooltip","linkbutton","menu","sidemenu","menubutton","splitbutton","switchbutton","progressbar","radiobutton","checkbox","tree","textbox","passwordbox","maskedbox","filebox","combo","combobox","combotree","combogrid","combotreegrid","tagbox","numberbox","validatebox","searchbox","spinner","numberspinner","timespinner","datetimespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","datalist","tabs","accordion","window","dialog","form", "daterangebox"],parse:function(_c){
var aa=[];
...
$.fn.form.defaults={fieldTypes:["tagbox","combobox","combotree","combogrid","combotreegrid","datetimebox","datebox","combo","datetimespinner","timespinner","numberspinner","spinner","slider","searchbox","numberbox","passwordbox","filebox","textbox","switchbutton","radiobutton","checkbox", "daterangebox"],novalidate:false,ajax:true,iframe:true,dirty:false,dirtyFields:[],url:null,queryParams:{},onSubmit:function(_665){
...
var _88d=$.extend({},_87f(["text","textbox","passwordbox","filebox","numberbox","numberspinner","combobox","combotree","combogrid","combotreegrid","datebox","datetimebox","timespinner","datetimespinner", "daterangebox"]),{textarea:{init:function(_88e,_88f){
...
_9cb.pagination({total:0,pageNumber:opts.pageNumber,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_9cc,_9cd){
opts.pageNumber=_9cc||1;
opts.pageSize=_9cd;
_9cb.pagination("refresh",{pageNumber:_9cc,pageSize:_9cd});
_9ce(_9bf);
}});
...
var _a07=_a06.pagination("options");
if(_a07.total!=data.total){
_a06.pagination("refresh",{pageNumber:opts.pageNumber,total:data.total});
if(opts.pageNumber!=_a07.pageNumber&&_a07.pageNumber>0){
opts.pageNumber=_a07.pageNumber;
_9ce(_9fe);
}
}
}
...
function _9ce(_a08,_a09,_a0a,_a0b,_a0c){
var opts=$.data(_a08,"treegrid").options;
var body=$(_a08).datagrid("getPanel").find("div.datagrid-body");
if(_a09==undefined&&opts.queryParams){
opts.queryParams.id=undefined;
}
if(_a0a){
opts.queryParams=_a0a;
}
var _a0d=$.extend({},opts.queryParams);
if(opts.pagination){
$.extend(_a0d,{page:opts.pageNumber,rows:opts.pageSize});
}
if(opts.sortName){
$.extend(_a0d,{sort:opts.sortName,order:opts.sortOrder});
}
var row=find(_a08,_a09);
if(opts.onBeforeLoad.call(_a08,row,_a0d)==false){
return;
}
var _a0e=body.find("tr[node-id=\""+_a09+"\"] span.tree-folder");
_a0e.addClass("tree-loading");
$(_a08).treegrid("loading");
var _a0f=opts.loader.call(_a08,_a0d,function(data){
_a0e.removeClass("tree-loading");
$(_a08).treegrid("loaded");
_9fd(_a08,_a09,data,_a0b);
if(_a0c){
_a0c();
}
},function(){
_a0e.removeClass("tree-loading");
$(_a08).treegrid("loaded");
opts.onLoadError.apply(_a08,arguments);
if(_a0c){
_a0c();
}
});
...
function _a10(_a11){
var _a12=_a13(_a11);
return _a12.length?_a12[0]:null;
};
function _a13(_a14){
return $.data(_a14,"treegrid").data;
};
function _9f1(_a15,_a16){
var row=find(_a15,_a16);
if(row._parentId){
return find(_a15,row._parentId);
}else{
return null;
}
};
function _9d3(_a17,_a18){
var data=$.data(_a17,"treegrid").data;
if(_a18){
var _a19=find(_a17,_a18);
data=_a19?(_a19.children||[]):[];
}
var _a1a=[];
$.easyui.forEach(data,true,function(node){
_a1a.push(node);
...
function find(_a1e,_a1f){
var _a20=$.data(_a1e,"treegrid");
var opts=_a20.options;
var _a21=null;
$.easyui.forEach(_a20.data,true,function(node){
if(node[opts.idField]==_a1f){
_a21=node;
return false;
}
});
...
if(opts.onBeforeCollapse.call(_a23,row)==false){
return;
}
hit.removeClass("tree-expanded tree-expanded-hover").addClass("tree-collapsed");
hit.next().removeClass("tree-folder-open");
...
if(opts.onBeforeExpand.call(_a26,row)==false){
return;
}
hit.removeClass("tree-collapsed tree-collapsed-hover").addClass("tree-expanded");
hit.next().addClass("tree-folder-open");
var _a28=tr.next("tr.treegrid-tr-tree");
if(_a28.length){
var cc=_a28.children("td").children("div");
_a29(cc);
}else{
_9f6(_a26,row[opts.idField]);
var _a28=tr.next("tr.treegrid-tr-tree");
var cc=_a28.children("td").children("div");
cc.hide();
var _a2a=$.extend({},opts.queryParams||{});
_a2a.id=row[opts.idField];
_9ce(_a26,row[opts.idField],_a2a,true,function(){
if(cc.is(":empty")){
_a28.remove();
}else{
_a29(cc);
...
if(_a3a.parent){
var tr=opts.finder.getTr(_a39,_a3a.parent);
if(tr.next("tr.treegrid-tr-tree").length==0){
_9f6(_a39,_a3a.parent);
}
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
var _a3c=cell.children("span.tree-icon");
if(_a3c.hasClass("tree-file")){
_a3c.removeClass("tree-file").addClass("tree-folder tree-folder-open");
var hit=$("<span class=\"tree-hit tree-expanded\"></span>").insertBefore(_a3c);
if(hit.prev().length){
hit.prev().remove();
}
}
}
_9fd(_a39,_a3a.parent,_a3a.data,_a3b.data.length>0,true);
};
function _a3d(_a3e,_a3f){
var ref=_a3f.before||_a3f.after;
var opts=$.data(_a3e,"treegrid").options;
var _a40=_9f1(_a3e,ref);
_a38(_a3e,{parent:(_a40?_a40[opts.idField]:null),data:[_a3f.data]});
var _a41=_a40?_a40.children:$(_a3e).treegrid("getRoots");
for(var i=0;i<_a41.length;i++){
if(_a41[i][opts.idField]==ref){
var _a42=_a41[_a41.length-1];
_a41.splice(_a3f.before?i:(i+1),0,_a42);
_a41.splice(_a41.length-1,1);
break;
}
}
_a43(true);
...
function _a43(_a44){
var _a45=_a44?1:2;
var tr=opts.finder.getTr(_a3e,_a3f.data[opts.idField],"body",_a45);
var _a46=tr.closest("table.datagrid-btable");
tr=tr.parent().children();
var dest=opts.finder.getTr(_a3e,ref,"body",_a45);
if(_a3f.before){
...
var prow=_9f1(_a48,_a49);
$(_a48).datagrid("deleteRow",_a49);
$.easyui.removeArrayItem(_a4a.checkedRows,opts.idField,_a49);
_9d7(_a48);
if(prow){
_9f3(_a48,prow[opts.idField]);
}
_a4a.total-=1;
$(_a48).datagrid("getPager").pagination("refresh",{total:_a4a.total});
$(_a48).treegrid("showLines");
};
function _a4b(_a4c){
var t=$(_a4c);
...
var _a4d=t.treegrid("getRoots");
if(_a4d.length>1){
_a4e(_a4d[0]).addClass("tree-root-first");
}else{
if(_a4d.length==1){
_a4e(_a4d[0]).addClass("tree-root-one");
}
}
_a4f(_a4d);
_a50(_a4d);
...
if(_a51.length){
var cell=_a4e(_a51[_a51.length-1]);
cell.addClass("tree-node-last");
cell.find(".tree-join").removeClass("tree-join").addClass("tree-joinbottom");
}
};
function _a50(_a52){
$.map(_a52,function(node){
if(node.children&&node.children.length){
_a50(node.children);
}
});
for(var i=0;i<_a52.length-1;i++){
var node=_a52[i];
var _a53=t.treegrid("getLevel",node[opts.idField]);
var tr=opts.finder.getTr(_a4c,node[opts.idField]);
var cc=tr.next().find("tr.datagrid-row td[field=\""+opts.treeField+"\"] div.datagrid-cell");
cc.find("span:eq("+(_a53-1)+")").addClass("tree-line");
}
};
function _a4e(node){
var tr=opts.finder.getTr(_a4c,node[opts.idField]);
...
$.fn.treegrid=function(_a54,_a55){
if(typeof _a54=="string"){
var _a56=$.fn.treegrid.methods[_a54];
if(_a56){
return _a56(this,_a55);
}else{
return this.datagrid(_a54,_a55);
}
}
_a54=_a54||{};
return this.each(function(){
var _a57=$.data(this,"treegrid");
if(_a57){
$.extend(_a57.options,_a54);
}else{
_a57=$.data(this,"treegrid",{options:$.extend({},$.fn.treegrid.defaults,$.fn.treegrid.parseOptions(this),_a54),data:[],checkedRows:[],tmpIds:[]});
}
_9be(this);
if(_a57.options.data){
$(this).treegrid("loadData",_a57.options.data);
}
_9ce(this);
});
};
...
},resize:function(jq,_a58){
return jq.each(function(){
$(this).datagrid("resize",_a58);
});
},fixRowHeight:function(jq,_a59){
return jq.each(function(){
_9cf(this,_a59);
});
},loadData:function(jq,data){
...
},load:function(jq,_a5a){
return jq.each(function(){
$(this).treegrid("options").pageNumber=1;
$(this).treegrid("getPager").pagination({pageNumber:1});
$(this).treegrid("reload",_a5a);
});
...
_a5b=$.extend({},opts.queryParams);
_a5b.id=id;
}
if(_a5b.id){
var node=$(this).treegrid("find",_a5b.id);
if(node.children){
node.children.splice(0,node.children.length);
}
opts.queryParams=_a5b;
var tr=opts.finder.getTr(this,_a5b.id);
...
},reloadFooter:function(jq,_a5c){
return jq.each(function(){
var opts=$.data(this,"treegrid").options;
var dc=$.data(this,"datagrid").dc;
if(_a5c){
$.data(this,"treegrid").footer=_a5c;
}
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,this,dc.footer1,true);
opts.view.renderFooter.call(opts.view,this,dc.footer2,false);
...
},append:function(jq,_a5d){
return jq.each(function(){
_a38(this,_a5d);
});
},insert:function(jq,_a5e){
return jq.each(function(){
_a3d(this,_a5e);
});
...
},update:function(jq,_a5f){
return jq.each(function(){
var opts=$.data(this,"treegrid").options;
var row=_a5f.row;
opts.view.updateRow.call(opts.view,this,_a5f.id,row);
if(row.checked!=undefined){
row=find(this,_a5f.id);
...
var _a60=$(this).data("treegrid");
for(var i=0;i<_a60.tmpIds.length;i++){
_9e0(this,_a60.tmpIds[i],true,true);
}
_a60.tmpIds=[];
});
},getCheckedNodes:function(jq,_a61){
_a61=_a61||"checked";
var rows=[];
$.easyui.forEach(jq.data("treegrid").checkedRows,false,function(row){
if(row.checkState==_a61){
rows.push(row);
}
});
return rows;
...
return jq.each(function(){
var _a62=this;
var opts=$(_a62).treegrid("options");
$(_a62).datagrid("clearChecked");
$.map($(_a62).treegrid("getCheckedNodes"),function(row){
_9e0(_a62,row[opts.idField],false,true);
});
});
}};
$.fn.treegrid.parseOptions=function(_a63){
return $.extend({},$.fn.datagrid.parseOptions(_a63),$.parser.parseOptions(_a63,["treeField",{checkbox:"boolean",cascadeCheck:"boolean",onlyLeafCheck:"boolean"},{animate:"boolean"}]));
};
var _a64=$.extend({},$.fn.datagrid.defaults.view,{render:function(_a65,_a66,_a67){
var opts=$.data(_a65,"treegrid").options;
var _a68=$(_a65).datagrid("getColumnFields",_a67);
var _a69=$.data(_a65,"datagrid").rowIdPrefix;
if(_a67){
if(!(opts.rownumbers||(opts.frozenColumns&&opts.frozenColumns.length))){
return;
}
...
var _a6a=_a6b.call(this,_a67,this.treeLevel,this.treeNodes);
$(_a66).append(_a6a.join(""));
}
function _a6b(_a6c,_a6d,_a6e){
var _a6f=$(_a65).treegrid("getParent",_a6e[0][opts.idField]);
var _a70=(_a6f?_a6f.children.length:$(_a65).treegrid("getRoots").length)-_a6e.length;
var _a71=["<table class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<_a6e.length;i++){
var row=_a6e[i];
if(row.state!="open"&&row.state!="closed"){
row.state="open";
}
var css=opts.rowStyler?opts.rowStyler.call(_a65,row):"";
var cs=this.getStyleValue(css);
var cls="class=\"datagrid-row "+(_a70++%2&&opts.striped?"datagrid-row-alt ":" ")+cs.c+"\"";
var _a72=cs.s?"style=\""+cs.s+"\"":"";
var _a73=_a69+"-"+(_a6c?1:2)+"-"+row[opts.idField];
_a71.push("<tr id=\""+_a73+"\" node-id=\""+row[opts.idField]+"\" "+cls+" "+_a72+">");
_a71=_a71.concat(view.renderRow.call(view,_a65,_a68,_a6c,_a6d,row));
_a71.push("</tr>");
if(row.children&&row.children.length){
var tt=_a6b.call(this,_a6c,_a6d+1,row.children);
var v=row.state=="closed"?"none":"block";
_a71.push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan="+(_a68.length+(opts.rownumbers?1:0))+"><div style=\"display:"+v+"\">");
_a71=_a71.concat(tt);
_a71.push("</div></td></tr>");
}
}
...
},renderFooter:function(_a74,_a75,_a76){
var opts=$.data(_a74,"treegrid").options;
var rows=$.data(_a74,"treegrid").footer||[];
var _a77=$(_a74).datagrid("getColumnFields",_a76);
var _a78=["<table class=\"datagrid-ftable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
var row=rows[i];
row[opts.idField]=row[opts.idField]||("foot-row-id"+i);
_a78.push("<tr class=\"datagrid-row\" node-id=\""+row[opts.idField]+"\">");
_a78.push(this.renderRow.call(this,_a74,_a77,_a76,0,row));
_a78.push("</tr>");
}
_a78.push("</tbody></table>");
$(_a75).html(_a78.join(""));
},renderRow:function(_a79,_a7a,_a7b,_a7c,row){
var _a7d=$.data(_a79,"treegrid");
var opts=_a7d.options;
var cc=[];
if(_a7b&&opts.rownumbers){
cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">0</div></td>");
}
for(var i=0;i<_a7a.length;i++){
var _a7e=_a7a[i];
var col=$(_a79).datagrid("getColumnOption",_a7e);
if(col){
var css=col.styler?(col.styler(row[_a7e],row)||""):"";
var cs=this.getStyleValue(css);
var cls=cs.c?"class=\""+cs.c+"\"":"";
var _a7f=col.hidden?"style=\"display:none;"+cs.s+"\"":(cs.s?"style=\""+cs.s+"\"":"");
cc.push("<td field=\""+_a7e+"\" "+cls+" "+_a7f+">");
var _a7f="";
if(!col.checkbox){
if(col.align){
_a7f+="text-align:"+col.align+";";
}
if(!opts.nowrap){
_a7f+="white-space:normal;height:auto;";
}else{
if(opts.autoRowHeight){
_a7f+="height:auto;";
}
...
cc.push("<div style=\""+_a7f+"\" ");
if(col.checkbox){
cc.push("class=\"datagrid-cell-check ");
}else{
cc.push("class=\"datagrid-cell "+col.cellClass);
}
if(_a7e==opts.treeField){
cc.push(" tree-node");
}
cc.push("\">");
if(col.checkbox){
...
cc.push(" name=\""+_a7e+"\" value=\""+(row[_a7e]!=undefined?row[_a7e]:"")+"\">");
}else{
var val=null;
if(col.formatter){
val=col.formatter(row[_a7e],row);
}else{
val=row[_a7e];
}
if(_a7e==opts.treeField){
for(var j=0;j<_a7c;j++){
cc.push("<span class=\"tree-indent\"></span>");
}
if(row.state=="closed"){
cc.push("<span class=\"tree-hit tree-collapsed\"></span>");
...
if(this.hasCheckbox(_a79,row)){
var flag=0;
var crow=$.easyui.getArrayItem(_a7d.checkedRows,opts.idField,row[opts.idField]);
if(crow){
flag=crow.checkState=="checked"?1:2;
row.checkState=crow.checkState;
row.checked=crow.checked;
$.easyui.addArrayItem(_a7d.checkedRows,opts.idField,row);
}else{
var prow=$.easyui.getArrayItem(_a7d.checkedRows,opts.idField,row._parentId);
...
if(row.checked){
$.easyui.addArrayItem(_a7d.tmpIds,row[opts.idField]);
}
}
...
return cc.join("");
},hasCheckbox:function(_a80,row){
var opts=$.data(_a80,"treegrid").options;
if(opts.checkbox){
if($.isFunction(opts.checkbox)){
if(opts.checkbox.call(_a80,row)){
return true;
}else{
return false;
}
...
return false;
},refreshRow:function(_a81,id){
this.updateRow.call(this,_a81,id,{});
},updateRow:function(_a82,id,row){
var opts=$.data(_a82,"treegrid").options;
var _a83=$(_a82).treegrid("find",id);
$.extend(_a83,row);
var _a84=$(_a82).treegrid("getLevel",id)-1;
var _a85=opts.rowStyler?opts.rowStyler.call(_a82,_a83):"";
var _a86=$.data(_a82,"datagrid").rowIdPrefix;
var _a87=_a83[opts.idField];
function _a88(_a89){
var _a8a=$(_a82).treegrid("getColumnFields",_a89);
var tr=opts.finder.getTr(_a82,id,"body",(_a89?1:2));
var _a8b=tr.find("div.datagrid-cell-rownumber").html();
var _a8c=tr.find("div.datagrid-cell-check input[type=checkbox]").is(":checked");
tr.html(this.renderRow(_a82,_a8a,_a89,_a84,_a83));
tr.attr("style",_a85||"");
tr.find("div.datagrid-cell-rownumber").html(_a8b);
if(_a8c){
tr.find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked",true);
}
if(_a87!=id){
tr.attr("id",_a86+"-"+(_a89?1:2)+"-"+_a87);
tr.attr("node-id",_a87);
}
};
_a88.call(this,true);
_a88.call(this,false);
$(_a82).treegrid("fixRowHeight",id);
},deleteRow:function(_a8d,id){
var opts=$.data(_a8d,"treegrid").options;
var tr=opts.finder.getTr(_a8d,id);
tr.next("tr.treegrid-tr-tree").remove();
tr.remove();
var _a8e=del(id);
if(_a8e){
if(_a8e.children.length==0){
tr=opts.finder.getTr(_a8d,_a8e[opts.idField]);
tr.next("tr.treegrid-tr-tree").remove();
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
...
this.setEmptyMsg(_a8d);
function del(id){
var cc;
var _a8f=$(_a8d).treegrid("getParent",id);
if(_a8f){
cc=_a8f.children;
}else{
cc=$(_a8d).treegrid("getData");
}
for(var i=0;i<cc.length;i++){
...
},onBeforeRender:function(_a90,_a91,data){
if($.isArray(_a91)){
data={total:_a91.length,rows:_a91};
_a91=null;
}
if(!data){
return false;
}
var _a92=$.data(_a90,"treegrid");
var opts=_a92.options;
if(data.length==undefined){
if(data.footer){
_a92.footer=data.footer;
}
if(data.total){
_a92.total=data.total;
}
data=this.transfer(_a90,_a91,data.rows);
}else{
...
row._parentId=_a95;
if(row.children&&row.children.length){
_a93(row.children,row[opts.idField]);
}
}
};
_a93(data,_a91);
...
this.sort(_a90,data);
this.treeNodes=data;
this.treeLevel=$(_a90).treegrid("getLevel",_a91);
var node=find(_a90,_a91);
if(node){
if(node.children){
...
_a92.data=_a92.data.concat(data);
}
},sort:function(_a96,data){
var opts=$.data(_a96,"treegrid").options;
if(!opts.remoteSort&&opts.sortName){
var _a97=opts.sortName.split(",");
var _a98=opts.sortOrder.split(",");
_a99(data);
}
function _a99(rows){
...
var sn=_a97[i];
var so=_a98[i];
var col=$(_a96).treegrid("getColumnOption",sn);
var _a9a=col.sorter||function(a,b){
return a==b?0:(a>b?1:-1);
};
r=_a9a(r1[sn],r2[sn])*(so=="asc"?1:-1);
if(r!=0){
return r;
}
}
...
for(var i=0;i<rows.length;i++){
var _a9b=rows[i].children;
if(_a9b&&_a9b.length){
_a99(_a9b);
}
}
};
},transfer:function(_a9c,_a9d,data){
var opts=$.data(_a9c,"treegrid").options;
var rows=$.extend([],data);
var _a9e=_a9f(_a9d,rows);
var toDo=$.extend([],_a9e);
while(toDo.length){
var node=toDo.shift();
var _aa0=_a9f(node[opts.idField],rows);
if(_aa0.length){
if(node.children){
node.children=node.children.concat(_aa0);
}else{
node.children=_aa0;
}
toDo=toDo.concat(_aa0);
}
}
return _a9e;
function _a9f(_aa1,rows){
var rr=[];
for(var i=0;i<rows.length;i++){
var row=rows[i];
if(row._parentId==_aa1){
rr.push(row);
rows.splice(i,1);
i--;
}
...
$.fn.treegrid.defaults=$.extend({},$.fn.datagrid.defaults,{treeField:null,checkbox:false,cascadeCheck:true,onlyLeafCheck:false,lines:false,animate:false,singleSelect:true,view:_a64,rowEvents:$.extend({},$.fn.datagrid.defaults.rowEvents,{mouseover:_9d9(true),mouseout:_9d9(false),click:_9db}),loader:function(_aa2,_aa3,_aa4){
var opts=$(this).treegrid("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_aa2,dataType:"json",success:function(data){
_aa3(data);
},error:function(){
_aa4.apply(this,arguments);
}});
},loadFilter:function(data,_aa5){
return data;
},finder:{getTr:function(_aa6,id,type,_aa7){
type=type||"body";
_aa7=_aa7||0;
var dc=$.data(_aa6,"datagrid").dc;
if(_aa7==0){
var opts=$.data(_aa6,"treegrid").options;
var tr1=opts.finder.getTr(_aa6,id,type,1);
var tr2=opts.finder.getTr(_aa6,id,type,2);
return tr1.add(tr2);
}else{
if(type=="body"){
var tr=$("#"+$.data(_aa6,"datagrid").rowIdPrefix+"-"+_aa7+"-"+id);
if(!tr.length){
tr=(_aa7==1?dc.body1:dc.body2).find("tr[node-id=\""+id+"\"]");
}
return tr;
}else{
if(type=="footer"){
return (_aa7==1?dc.footer1:dc.footer2).find("tr[node-id=\""+id+"\"]");
}else{
if(type=="selected"){
return (_aa7==1?dc.body1:dc.body2).find("tr.datagrid-row-selected");
}else{
if(type=="highlight"){
return (_aa7==1?dc.body1:dc.body2).find("tr.datagrid-row-over");
}else{
if(type=="checked"){
return (_aa7==1?dc.body1:dc.body2).find("tr.datagrid-row-checked");
}else{
if(type=="last"){
return (_aa7==1?dc.body1:dc.body2).find("tr:last[node-id]");
}else{
if(type=="allbody"){
return (_aa7==1?dc.body1:dc.body2).find("tr[node-id]");
}else{
if(type=="allfooter"){
return (_aa7==1?dc.footer1:dc.footer2).find("tr[node-id]");
}
}
}
}
...
},getRow:function(_aa8,p){
var id=(typeof p=="object")?p.attr("node-id"):p;
return $(_aa8).treegrid("find",id);
},getRows:function(_aa9){
return $(_aa9).treegrid("getChildren");
}},onBeforeLoad:function(row,_aaa){
...
},onClickCell:function(_aab,row){
},onDblClickCell:function(_aac,row){
},onContextMenu:function(e,row){
},onBeforeEdit:function(row){
},onAfterEdit:function(row,_aad){
},onCancelEdit:function(row){
},onBeforeCheckNode:function(row,_aae){
},onCheckNode:function(row,_aaf){
}});
})(jQuery);
(function($){
function _ab0(_ab1){
var opts=$.data(_ab1,"datalist").options;
$(_ab1).datagrid($.extend({},opts,{cls:"datalist"+(opts.lines?" datalist-lines":""),frozenColumns:(opts.frozenColumns&&opts.frozenColumns.length)?opts.frozenColumns:(opts.checkbox?[[{field:"_ck",checkbox:true}]]:undefined),columns:(opts.columns&&opts.columns.length)?opts.columns:[[{field:opts.textField,width:"100%",formatter:function(_ab2,row,_ab3){
return opts.textFormatter?opts.textFormatter(_ab2,row,_ab3):_ab2;
}}]]}));
};
var _ab4=$.extend({},$.fn.datagrid.defaults.view,{render:function(_ab5,_ab6,_ab7){
var _ab8=$.data(_ab5,"datagrid");
var opts=_ab8.options;
if(opts.groupField){
var g=this.groupRows(_ab5,_ab8.data.rows);
this.groups=g.groups;
_ab8.data.rows=g.rows;
var _ab9=[];
for(var i=0;i<g.groups.length;i++){
_ab9.push(this.renderGroup.call(this,_ab5,i,g.groups[i],_ab7));
}
$(_ab6).html(_ab9.join(""));
}else{
$(_ab6).html(this.renderTable(_ab5,0,_ab8.data.rows,_ab7));
}
},renderGroup:function(_aba,_abb,_abc,_abd){
var _abe=$.data(_aba,"datagrid");
var opts=_abe.options;
var _abf=$(_aba).datagrid("getColumnFields",_abd);
var _ac0=[];
_ac0.push("<div class=\"datagrid-group\" group-index="+_abb+">");
if(!_abd){
_ac0.push("<span class=\"datagrid-group-title\">");
_ac0.push(opts.groupFormatter.call(_aba,_abc.value,_abc.rows));
_ac0.push("</span>");
}
_ac0.push("</div>");
_ac0.push(this.renderTable(_aba,_abc.startIndex,_abc.rows,_abd));
return _ac0.join("");
},groupRows:function(_ac1,rows){
var _ac2=$.data(_ac1,"datagrid");
var opts=_ac2.options;
var _ac3=[];
for(var i=0;i<rows.length;i++){
var row=rows[i];
var _ac4=_ac5(row[opts.groupField]);
if(!_ac4){
_ac4={value:row[opts.groupField],rows:[row]};
_ac3.push(_ac4);
}else{
_ac4.rows.push(row);
}
...
var _ac6=0;
var rows=[];
for(var i=0;i<_ac3.length;i++){
var _ac4=_ac3[i];
_ac4.startIndex=_ac6;
_ac6+=_ac4.rows.length;
rows=rows.concat(_ac4.rows);
}
return {groups:_ac3,rows:rows};
function _ac5(_ac7){
for(var i=0;i<_ac3.length;i++){
var _ac8=_ac3[i];
if(_ac8.value==_ac7){
...
$.fn.datalist=function(_ac9,_aca){
if(typeof _ac9=="string"){
var _acb=$.fn.datalist.methods[_ac9];
if(_acb){
...
_ac9=_ac9||{};
return this.each(function(){
var _acc=$.data(this,"datalist");
if(_acc){
$.extend(_acc.options,_ac9);
}else{
var opts=$.extend({},$.fn.datalist.defaults,$.fn.datalist.parseOptions(this),_ac9);
opts.columns=$.extend(true,[],opts.columns);
_acc=$.data(this,"datalist",{options:opts});
}
_ab0(this);
...
$.fn.datalist.parseOptions=function(_acd){
return $.extend({},$.fn.datagrid.parseOptions(_acd),$.parser.parseOptions(_acd,["valueField","textField","groupField",{checkbox:"boolean",lines:"boolean"}]));
};
$.fn.datalist.parseData=function(_ace){
var opts=$.data(_ace,"datalist").options;
var data={total:0,rows:[]};
$(_ace).children().each(function(){
var _acf=$.parser.parseOptions(this,["value","group"]);
var row={};
var html=$(this).html();
row[opts.valueField]=_acf.value!=undefined?_acf.value:html;
row[opts.textField]=html;
if(opts.groupField){
row[opts.groupField]=_acf.group;
}
data.total++;
data.rows.push(row);
});
...
$.fn.datalist.defaults=$.extend({},$.fn.datagrid.defaults,{fitColumns:true,singleSelect:true,showHeader:false,checkbox:false,lines:false,valueField:"value",textField:"text",groupField:"",view:_ab4,textFormatter:function(_ad0,row){
return _ad0;
},groupFormatter:function(_ad1,rows){
return _ad1;
}});
})(jQuery);
(function($){
...
function _ad3(_ad4){
var _ad5=$.data(_ad4,"combo");
var opts=_ad5.options;
if(!_ad5.panel){
_ad5.panel=$("<div class=\"combo-panel\"></div>").appendTo("body");
_ad5.panel.panel({minWidth:opts.panelMinWidth,maxWidth:opts.panelMaxWidth,minHeight:opts.panelMinHeight,maxHeight:opts.panelMaxHeight,doSize:false,closed:true,cls:"combo-p",style:{position:"absolute",zIndex:10},onOpen:function(){
var _ad6=$(this).panel("options").comboTarget;
var _ad7=$.data(_ad6,"combo");
if(_ad7){
_ad7.options.onShowPanel.call(_ad6);
}
},onBeforeClose:function(){
_ad2($(this).parent());
},onClose:function(){
var _ad8=$(this).panel("options").comboTarget;
var _ad9=$(_ad8).data("combo");
if(_ad9){
_ad9.options.onHidePanel.call(_ad8);
}
}});
}
var _ada=$.extend(true,[],opts.icons);
if(opts.hasDownArrow){
_ada.push({iconCls:"combo-arrow",handler:function(e){
_adf(e.data.target);
}});
}
$(_ad4).addClass("combo-f").textbox($.extend({},opts,{icons:_ada,onChange:function(){
}}));
$(_ad4).attr("comboName",$(_ad4).attr("textboxName"));
_ad5.combo=$(_ad4).next();
_ad5.combo.addClass("combo");
_ad5.panel.unbind(".combo");
for(var _adb in opts.panelEvents){
_ad5.panel.bind(_adb+".combo",{target:_ad4},opts.panelEvents[_adb]);
}
};
function _adc(_add){
...
$(_add).textbox("destroy");
};
function _adf(_ae0){
var _ae1=$.data(_ae0,"combo").panel;
if(_ae1.is(":visible")){
var _ae2=_ae1.combo("combo");
_ae3(_ae2);
if(_ae2!=_ae0){
$(_ae0).combo("showPanel");
}
}else{
var p=$(_ae0).closest("div.combo-p").children(".combo-panel");
$("div.combo-panel:visible").not(_ae1).not(p).panel("close");
$(_ae0).combo("showPanel");
}
$(_ae0).combo("textbox").focus();
};
function _ad2(_ae4){
$(_ae4).find(".combo-f").each(function(){
...
var p=$(_ae6).closest("div.combo-p").children(".combo-panel");
$("div.combo-panel:visible").not(p).each(function(){
var _ae8=$(this).combo("combo");
if(_ae8!=_ae6){
_ae3(_ae8);
}
});
...
var t=$(_aea);
var _aeb=t.data("combo");
var opts=t.combo("options");
_aeb.panel.panel("options").comboTarget=_aea;
switch(e.keyCode){
case 38:
opts.keyHandler.up.call(_aea,e);
break;
case 40:
opts.keyHandler.down.call(_aea,e);
break;
case 37:
opts.keyHandler.left.call(_aea,e);
break;
case 39:
opts.keyHandler.right.call(_aea,e);
break;
case 13:
e.preventDefault();
opts.keyHandler.enter.call(_aea,e);
return false;
case 9:
case 27:
_ae3(_aea);
...
_aeb.timer=setTimeout(function(){
var q=t.combo("getText");
if(_aeb.previousText!=q){
_aeb.previousText=q;
t.combo("showPanel");
opts.keyHandler.query.call(_aea,q,e);
t.combo("validate");
}
},opts.delay);
}
...
var _af2=_af1.combo;
var _af3=_af1.panel;
var opts=$(_af0).combo("options");
var _af4=_af3.panel("options");
_af4.comboTarget=_af0;
if(_af4.closed){
_af3.panel("panel").show().css({zIndex:($.fn.menu?$.fn.menu.defaults.zIndex++:($.fn.window?$.fn.window.defaults.zIndex++:99)),left:-999999});
_af3.panel("resize",{width:(opts.panelWidth?opts.panelWidth:_af2._outerWidth()),height:opts.panelHeight});
_af3.panel("panel").hide();
_af3.panel("open");
}
(function(){
if(_af4.comboTarget==_af0&&_af3.is(":visible")){
_af3.panel("move",{left:_af5(),top:_af6()});
setTimeout(arguments.callee,200);
}
})();
function _af5(){
var left=_af2.offset().left;
if(opts.panelAlign=="right"){
left+=_af2._outerWidth()-_af3._outerWidth();
}
if(left+_af3._outerWidth()>$(window)._outerWidth()+$(document).scrollLeft()){
left=$(window)._outerWidth()+$(document).scrollLeft()-_af3._outerWidth();
}
if(left<0){
left=0;
}
...
var top=_af2.offset().top-_af3._outerHeight();
}else{
if(opts.panelValign=="bottom"){
var top=_af2.offset().top+_af2._outerHeight();
}else{
var top=_af2.offset().top+_af2._outerHeight();
if(top+_af3._outerHeight()>$(window)._outerHeight()+$(document).scrollTop()){
top=_af2.offset().top-_af3._outerHeight();
}
if(top<$(document).scrollTop()){
top=_af2.offset().top+_af2._outerHeight();
}
}
}
return top;
...
function _ae3(_af7){
var _af8=$.data(_af7,"combo").panel;
_af8.panel("close");
};
function _af9(_afa,text){
var _afb=$.data(_afa,"combo");
var _afc=$(_afa).textbox("getText");
if(_afc!=text){
$(_afa).textbox("setText",text);
}
_afb.previousText=text;
};
function _afd(_afe){
...
var _b00=$(_afe).next();
var _b01=[];
_b00.find(".textbox-value").each(function(){
_b01.push($(this).val());
});
if(opts.multivalue){
return _b01;
}else{
return _b01.length?_b01[0].split(opts.separator):_b01;
}
};
function _b02(_b03,_b04){
var _b05=$.data(_b03,"combo");
var _b06=_b05.combo;
var opts=$(_b03).combo("options");
if(!$.isArray(_b04)){
_b04=_b04.split(opts.separator);
}
var _b07=_afd(_b03);
_b06.find(".textbox-value").remove();
if(_b04.length){
if(opts.multivalue){
...
_b08(_b04.join(opts.separator));
}
}
function _b08(_b09){
var name=$(_b03).attr("textboxName")||"";
var _b0a=$("<input type=\"hidden\" class=\"textbox-value\">").appendTo(_b06);
_b0a.attr("name",name);
if(opts.disabled){
_b0a.attr("disabled","disabled");
}
_b0a.val(_b09);
};
var _b0b=(function(){
...
if(_b0b){
$(_b03).val(_b04.join(opts.separator));
if(opts.multiple){
opts.onChange.call(_b03,_b04,_b07);
}else{
opts.onChange.call(_b03,_b04[0],_b07[0]);
}
$(_b03).closest("form").trigger("_change",[_b03]);
}
};
function _b0c(_b0d){
var _b0e=_afd(_b0d);
...
function _b12(_b13){
var opts=$.data(_b13,"combo").options;
var _b14=opts.onChange;
opts.onChange=$.parser.emptyFn;
if(opts.multiple){
_b02(_b13,opts.value?opts.value:[]);
}else{
_b0f(_b13,opts.value);
}
opts.onChange=_b14;
};
$.fn.combo=function(_b15,_b16){
if(typeof _b15=="string"){
var _b17=$.fn.combo.methods[_b15];
if(_b17){
return _b17(this,_b16);
}else{
return this.textbox(_b15,_b16);
}
}
_b15=_b15||{};
return this.each(function(){
var _b18=$.data(this,"combo");
if(_b18){
$.extend(_b18.options,_b15);
if(_b15.value!=undefined){
_b18.options.originalValue=_b15.value;
}
}else{
_b18=$.data(this,"combo",{options:$.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_b15),previousText:""});
if(_b18.options.multiple&&_b18.options.value==""){
_b18.options.originalValue=[];
}else{
_b18.options.originalValue=_b18.options.value;
}
}
_ad3(this);
_b12(this);
...
$.fn.combo.parseOptions=function(_b1b){
var t=$(_b1b);
return $.extend({},$.fn.textbox.parseOptions(_b1b),$.parser.parseOptions(_b1b,["separator","panelAlign",{panelWidth:"number",hasDownArrow:"boolean",delay:"number",reversed:"boolean",multivalue:"boolean",selectOnNavigation:"boolean"},{panelMinWidth:"number",panelMaxWidth:"number",panelMinHeight:"number",panelMaxHeight:"number"}]),{panelHeight:(t.attr("panelHeight")=="auto"?"auto":parseInt(t.attr("panelHeight"))||undefined),multiple:(t.attr("multiple")?true:undefined)});
};
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_ae5,keydown:_ae9,paste:_ae9,drop:_ae9,blur:_aec},panelEvents:{mousedown:function(e){
e.preventDefault();
e.stopPropagation();
...
},onChange:function(_b1c,_b1d){
}});
})(jQuery);
(function($){
function _b1e(_b1f,_b20){
var _b21=$.data(_b1f,"combobox");
return $.easyui.indexOfArray(_b21.data,_b21.options.valueField,_b20);
};
function _b22(_b23,_b24){
var opts=$.data(_b23,"combobox").options;
var _b25=$(_b23).combo("panel");
var item=opts.finder.getEl(_b23,_b24);
if(item.length){
if(item.position().top<=0){
var h=_b25.scrollTop()+item.position().top;
_b25.scrollTop(h);
}else{
if(item.position().top+item.outerHeight()>_b25.height()){
var h=_b25.scrollTop()+item.position().top+item.outerHeight()-_b25.height();
_b25.scrollTop(h);
}
}
}
_b25.triggerHandler("scroll");
};
function nav(_b26,dir){
var opts=$.data(_b26,"combobox").options;
var _b27=$(_b26).combobox("panel");
var item=_b27.children("div.combobox-item-hover");
if(!item.length){
item=_b27.children("div.combobox-item-selected");
}
item.removeClass("combobox-item-hover");
var _b28="div.combobox-item:visible:not(.combobox-item-disabled):first";
var _b29="div.combobox-item:visible:not(.combobox-item-disabled):last";
if(!item.length){
item=_b27.children(dir=="next"?_b28:_b29);
}else{
if(dir=="next"){
item=item.nextAll(_b28);
if(!item.length){
item=_b27.children(_b28);
}
}else{
item=item.prevAll(_b28);
if(!item.length){
item=_b27.children(_b29);
}
}
}
if(item.length){
item.addClass("combobox-item-hover");
var row=opts.finder.getRow(_b26,item);
if(row){
$(_b26).combobox("scrollTo",row[opts.valueField]);
if(opts.selectOnNavigation){
_b2a(_b26,row[opts.valueField]);
}
}
}
};
function _b2a(_b2b,_b2c,_b2d){
var opts=$.data(_b2b,"combobox").options;
var _b2e=$(_b2b).combo("getValues");
if($.inArray(_b2c+"",_b2e)==-1){
if(opts.multiple){
_b2e.push(_b2c);
}else{
_b2e=[_b2c];
...
var _b33=$(_b31).combo("getValues");
var _b34=$.inArray(_b32+"",_b33);
if(_b34>=0){
_b33.splice(_b34,1);
_b2f(_b31,_b33);
}
};
function _b2f(_b35,_b36,_b37){
var opts=$.data(_b35,"combobox").options;
var _b38=$(_b35).combo("panel");
if(!$.isArray(_b36)){
_b36=_b36.split(opts.separator);
}
if(!opts.multiple){
_b36=_b36.length?[_b36[0]]:[""];
}
var _b39=$(_b35).combo("getValues");
if(_b38.is(":visible")){
_b38.find(".combobox-item-selected").each(function(){
var row=opts.finder.getRow(_b35,$(this));
if(row){
if($.easyui.indexOfArray(_b39,row[opts.valueField])==-1){
...
$.map(_b39,function(v){
if($.easyui.indexOfArray(_b36,v)==-1){
var el=opts.finder.getEl(_b35,v);
if(el.hasClass("combobox-item-selected")){
el.removeClass("combobox-item-selected");
opts.onUnselect.call(_b35,opts.finder.getRow(_b35,v));
}
}
});
var _b3a=null;
...
var v=_b36[i];
var s=v;
var row=opts.finder.getRow(_b35,v);
if(row){
...
opts.onSelect.call(_b35,row);
}
}else{
s=_b3b(v,opts.mappingRows)||v;
}
vv.push(v);
ss.push(s);
}
if(!_b37){
$(_b35).combo("setText",ss.join(opts.separator));
}
if(opts.showItemIcon){
var tb=$(_b35).combobox("textbox");
tb.removeClass("textbox-bgicon "+opts.textboxIconCls);
if(_b3a&&_b3a.iconCls){
tb.addClass("textbox-bgicon "+_b3a.iconCls);
opts.textboxIconCls=_b3a.iconCls;
}
}
$(_b35).combo("setValues",vv);
_b38.triggerHandler("scroll");
function _b3b(_b3c,a){
var item=$.easyui.getArrayItem(a,opts.valueField,_b3c);
return item?item[opts.textField]:undefined;
};
};
function _b3d(_b3e,data,_b3f){
var _b40=$.data(_b3e,"combobox");
var opts=_b40.options;
_b40.data=opts.loadFilter.call(_b3e,data);
opts.view.render.call(opts.view,_b3e,$(_b3e).combo("panel"),_b40.data);
var vv=$(_b3e).combobox("getValues");
$.easyui.forEach(_b40.data,false,function(row){
if(row["selected"]){
...
_b2f(_b3e,vv.length?[vv[vv.length-1]]:[],_b3f);
}
opts.onLoadSuccess.call(_b3e,data);
};
function _b41(_b42,url,_b43,_b44){
var opts=$.data(_b42,"combobox").options;
if(url){
opts.url=url;
}
_b43=$.extend({},opts.queryParams,_b43||{});
if(opts.onBeforeLoad.call(_b42,_b43)==false){
return;
}
opts.loader.call(_b42,_b43,function(data){
_b3d(_b42,data,_b44);
},function(){
opts.onLoadError.apply(this,arguments);
});
};
function _b45(_b46,q){
...
if(opts.mode=="remote"){
_b49(qq);
_b41(_b46,null,{q:q},true);
}else{
var _b4a=$(_b46).combo("panel");
_b4a.find(".combobox-item-hover").removeClass("combobox-item-hover");
_b4a.find(".combobox-item,.combobox-group").hide();
var data=_b47.data;
var vv=[];
$.map(qq,function(q){
q=$.trim(q);
...
for(var i=0;i<data.length;i++){
var row=data[i];
if(opts.filter.call(_b46,q,row)){
var v=row[opts.valueField];
var s=row[opts.textField];
var g=row[opts.groupField];
var item=opts.finder.getEl(_b46,v).show();
...
if(opts.groupField&&_b4c!=g){
opts.finder.getGroupEl(_b46,g).show();
_b4c=g;
}
}
}
...
function _b49(vv){
if(opts.reversed){
_b48.addClass("combobox-item-hover");
}else{
_b2f(_b46,opts.multiple?(q?vv:[]):vv,true);
}
};
};
function _b4d(_b4e){
...
var _b4f=t.combobox("panel");
var item=_b4f.children("div.combobox-item-hover");
if(item.length){
item.removeClass("combobox-item-hover");
var row=opts.finder.getRow(_b4e,item);
var _b50=row[opts.valueField];
if(opts.multiple){
if(item.hasClass("combobox-item-selected")){
t.combobox("unselect",_b50);
}else{
t.combobox("select",_b50);
}
}else{
t.combobox("select",_b50);
}
...
function _b51(_b52){
var _b53=$.data(_b52,"combobox");
var opts=_b53.options;
$(_b52).addClass("combobox-f");
$(_b52).combo($.extend({},opts,{onShowPanel:function(){
$(this).combo("panel").find("div.combobox-item:hidden,div.combobox-group:hidden").show();
_b2f(this,$(this).combobox("getValues"),true);
...
var row=opts.finder.getRow(_b57,item);
if(!row){
return;
}
if(opts.blurTimer){
...
opts.onClick.call(_b57,row);
var _b58=row[opts.valueField];
if(opts.multiple){
if(item.hasClass("combobox-item-selected")){
_b30(_b57,_b58);
}else{
...
$(_b57).combobox("setValue",_b58).combobox("hidePanel");
}
e.stopPropagation();
};
function _b59(e){
...
var _b5b=$(this).children(".combobox-stick");
if(!_b5b.length){
_b5b=$("<div class=\"combobox-stick\"></div>").appendTo(this);
}
_b5b.hide();
var _b5c=$(_b5a).data("combobox");
$(this).children(".combobox-group:visible").each(function(){
var g=$(this);
var _b5d=opts.finder.getGroup(_b5a,g);
var _b5e=_b5c.data[_b5d.startIndex+_b5d.count-1];
var last=opts.finder.getEl(_b5a,_b5e[opts.valueField]);
if(g.position().top<0&&last.position().top>0){
_b5b.show().html(g.html());
return false;
}
});
}
};
$.fn.combobox=function(_b5f,_b60){
if(typeof _b5f=="string"){
var _b61=$.fn.combobox.methods[_b5f];
if(_b61){
return _b61(this,_b60);
}else{
return this.combo(_b5f,_b60);
}
}
_b5f=_b5f||{};
return this.each(function(){
var _b62=$.data(this,"combobox");
if(_b62){
$.extend(_b62.options,_b5f);
}else{
_b62=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_b5f),data:[]});
}
_b51(this);
if(_b62.options.data){
_b3d(this,_b62.options.data);
}else{
...
var _b63=jq.combo("options");
return $.extend($.data(jq[0],"combobox").options,{width:_b63.width,height:_b63.height,originalValue:_b63.originalValue,disabled:_b63.disabled,readonly:_b63.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},setValues:function(jq,_b64){
return jq.each(function(){
var opts=$(this).combobox("options");
if($.isArray(_b64)){
_b64=$.map(_b64,function(_b65){
if(_b65&&typeof _b65=="object"){
$.easyui.addArrayItem(opts.mappingRows,opts.valueField,_b65);
return _b65[opts.valueField];
}else{
return _b65;
}
});
...
},setValue:function(jq,_b66){
return jq.each(function(){
$(this).combobox("setValues",$.isArray(_b66)?_b66:[_b66]);
});
},clear:function(jq){
return jq.each(function(){
_b2f(this,[]);
...
},select:function(jq,_b67){
return jq.each(function(){
_b2a(this,_b67);
});
},unselect:function(jq,_b68){
return jq.each(function(){
_b30(this,_b68);
});
},scrollTo:function(jq,_b69){
return jq.each(function(){
_b22(this,_b69);
});
}};
$.fn.combobox.parseOptions=function(_b6a){
var t=$(_b6a);
return $.extend({},$.fn.combo.parseOptions(_b6a),$.parser.parseOptions(_b6a,["valueField","textField","groupField","groupPosition","mode","method","url",{showItemIcon:"boolean",limitToList:"boolean"}]));
};
$.fn.combobox.parseData=function(_b6b){
var data=[];
var opts=$(_b6b).combobox("options");
$(_b6b).children().each(function(){
if(this.tagName.toLowerCase()=="optgroup"){
var _b6c=$(this).attr("label");
...
row[opts.groupField]=_b6e;
}
data.push(row);
};
};
var _b6f=0;
var _b70={render:function(_b71,_b72,data){
var _b73=$.data(_b71,"combobox");
var opts=_b73.options;
var _b74=$(_b71).attr("id")||"";
_b6f++;
_b73.itemIdPrefix=_b74+"_easyui_combobox_i"+_b6f;
_b73.groupIdPrefix=_b74+"_easyui_combobox_g"+_b6f;
_b73.groups=[];
var dd=[];
var _b75=undefined;
for(var i=0;i<data.length;i++){
...
if(_b75!=g){
_b75=g;
_b73.groups.push({value:g,startIndex:i,count:1});
dd.push("<div id=\""+(_b73.groupIdPrefix+"_"+(_b73.groups.length-1))+"\" class=\"combobox-group\">");
dd.push(opts.groupFormatter?opts.groupFormatter.call(_b71,g):g);
dd.push("</div>");
}else{
_b73.groups[_b73.groups.length-1].count++;
}
}else{
_b75=undefined;
}
var cls="combobox-item"+(row.disabled?" combobox-item-disabled":"")+(g?" combobox-gitem":"");
dd.push("<div id=\""+(_b73.itemIdPrefix+"_"+i)+"\" class=\""+cls+"\">");
if(opts.showItemIcon&&row.iconCls){
dd.push("<span class=\"combobox-icon "+row.iconCls+"\"></span>");
}
dd.push(opts.formatter?opts.formatter.call(_b71,row):s);
dd.push("</div>");
}
$(_b72).html(dd.join(""));
}};
$.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{valueField:"value",textField:"text",groupPosition:"static",groupField:null,groupFormatter:function(_b76){
return _b76;
},mode:"local",method:"post",url:null,data:null,queryParams:{},showItemIcon:false,limitToList:false,unselectedValues:[],mappingRows:[],view:_b70,keyHandler:{up:function(e){
nav(this,"prev");
e.preventDefault();
},down:function(e){
nav(this,"next");
...
var _b77=e.data.target;
var opts=$(_b77).combobox("options");
if(opts.reversed||opts.limitToList){
if(opts.blurTimer){
clearTimeout(opts.blurTimer);
}
opts.blurTimer=setTimeout(function(){
var _b78=$(_b77).parent().length;
if(_b78){
if(opts.reversed){
$(_b77).combobox("setValues",$(_b77).combobox("getValues"));
}else{
if(opts.limitToList){
var vv=[];
$.map($(_b77).combobox("getValues"),function(v){
var _b79=$.easyui.indexOfArray($(_b77).combobox("getData"),opts.valueField,v);
if(_b79>=0){
vv.push(v);
}
});
$(_b77).combobox("setValues",vv);
}
}
opts.blurTimer=null;
}
...
}}),panelEvents:{mouseover:_b54,mouseout:_b55,mousedown:function(e){
e.preventDefault();
e.stopPropagation();
},click:_b56,scroll:_b59},filter:function(q,row){
var opts=$(this).combobox("options");
return row[opts.textField].toLowerCase().indexOf(q.toLowerCase())>=0;
},formatter:function(row){
var opts=$(this).combobox("options");
return row[opts.textField];
},loader:function(_b7a,_b7b,_b7c){
var opts=$(this).combobox("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_b7a,dataType:"json",success:function(data){
_b7b(data);
},error:function(){
_b7c.apply(this,arguments);
}});
},loadFilter:function(data){
return data;
},finder:{getEl:function(_b7d,_b7e){
var _b7f=_b1e(_b7d,_b7e);
var id=$.data(_b7d,"combobox").itemIdPrefix+"_"+_b7f;
return $("#"+id);
},getGroupEl:function(_b80,_b81){
var _b82=$.data(_b80,"combobox");
var _b83=$.easyui.indexOfArray(_b82.groups,"value",_b81);
var id=_b82.groupIdPrefix+"_"+_b83;
return $("#"+id);
},getGroup:function(_b84,p){
var _b85=$.data(_b84,"combobox");
var _b86=p.attr("id").substr(_b85.groupIdPrefix.length+1);
return _b85.groups[parseInt(_b86)];
},getRow:function(_b87,p){
var _b88=$.data(_b87,"combobox");
var _b89=(p instanceof $)?p.attr("id").substr(_b88.itemIdPrefix.length+1):_b1e(_b87,p);
return _b88.data[parseInt(_b89)];
}},onBeforeLoad:function(_b8a){
},onLoadSuccess:function(data){
},onLoadError:function(){
},onSelect:function(_b8b){
},onUnselect:function(_b8c){
},onClick:function(_b8d){
}});
})(jQuery);
(function($){
function _b8e(_b8f){
var _b90=$.data(_b8f,"combotree");
var opts=_b90.options;
var tree=_b90.tree;
$(_b8f).addClass("combotree-f");
$(_b8f).combo($.extend({},opts,{onShowPanel:function(){
if(opts.editable){
tree.tree("doFilter","");
}
opts.onShowPanel.call(this);
...
if(!tree){
tree=$("<ul></ul>").appendTo(_b91);
_b90.tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _b92=$(_b8f).combotree("getValues");
if(opts.multiple){
$.map(tree.tree("getChecked"),function(node){
$.easyui.addArrayItem(_b92,node.id);
});
}
_b97(_b8f,_b92,_b90.remainText);
opts.onLoadSuccess.call(this,node,data);
},onClick:function(node){
if(opts.multiple){
$(this).tree(node.checked?"uncheck":"check",node.target);
}else{
$(_b8f).combo("hidePanel");
}
_b90.remainText=false;
_b94(_b8f);
opts.onClick.call(this,node);
},onCheck:function(node,_b93){
_b90.remainText=false;
_b94(_b8f);
opts.onCheck.call(this,node,_b93);
}}));
};
function _b94(_b95){
...
_b97(_b95,vv,_b96.remainText);
};
function _b97(_b98,_b99,_b9a){
var _b9b=$.data(_b98,"combotree");
var opts=_b9b.options;
var tree=_b9b.tree;
var _b9c=tree.tree("options");
var _b9d=_b9c.onBeforeCheck;
var _b9e=_b9c.onCheck;
var _b9f=_b9c.onSelect;
_b9c.onBeforeCheck=_b9c.onCheck=_b9c.onSelect=function(){
};
if(!$.isArray(_b99)){
_b99=_b99.split(opts.separator);
}
if(!opts.multiple){
_b99=_b99.length?[_b99[0]]:[""];
}
var vv=$.map(_b99,function(_ba0){
return String(_ba0);
});
...
ss.push(_ba2(v,opts.mappingRows)||v);
...
_b9c.onBeforeCheck=_b9d;
_b9c.onCheck=_b9e;
_b9c.onSelect=_b9f;
if(!_b9a){
var s=ss.join(opts.separator);
if($(_b98).combo("getText")!=s){
$(_b98).combo("setText",s);
}
}
$(_b98).combo("setValues",vv);
function _ba2(_ba3,a){
var item=$.easyui.getArrayItem(a,"id",_ba3);
return item?_ba1(item):undefined;
};
function _ba1(node){
return node[opts.textField||""]||node.text;
};
};
function _ba4(_ba5,q){
var _ba6=$.data(_ba5,"combotree");
var opts=_ba6.options;
var tree=_ba6.tree;
_ba6.remainText=true;
tree.tree("doFilter",opts.multiple?q.split(opts.separator):q);
};
function _ba7(_ba8){
var _ba9=$.data(_ba8,"combotree");
_ba9.remainText=false;
$(_ba8).combotree("setValues",$(_ba8).combotree("getValues"));
$(_ba8).combotree("hidePanel");
};
$.fn.combotree=function(_baa,_bab){
if(typeof _baa=="string"){
var _bac=$.fn.combotree.methods[_baa];
if(_bac){
return _bac(this,_bab);
}else{
return this.combo(_baa,_bab);
}
}
_baa=_baa||{};
return this.each(function(){
var _bad=$.data(this,"combotree");
if(_bad){
$.extend(_bad.options,_baa);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_baa)});
}
_b8e(this);
});
};
$.fn.combotree.methods={options:function(jq){
var _bae=jq.combo("options");
return $.extend($.data(jq[0],"combotree").options,{width:_bae.width,height:_bae.height,originalValue:_bae.originalValue,disabled:_bae.disabled,readonly:_bae.readonly});
},clone:function(jq,_baf){
var t=jq.combo("clone",_baf);
...
},setValues:function(jq,_bb0){
return jq.each(function(){
var opts=$(this).combotree("options");
if($.isArray(_bb0)){
_bb0=$.map(_bb0,function(_bb1){
if(_bb1&&typeof _bb1=="object"){
$.easyui.addArrayItem(opts.mappingRows,"id",_bb1);
return _bb1.id;
}else{
return _bb1;
}
...
},setValue:function(jq,_bb2){
return jq.each(function(){
$(this).combotree("setValues",$.isArray(_bb2)?_bb2:[_bb2]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combotree.parseOptions=function(_bb3){
return $.extend({},$.fn.combo.parseOptions(_bb3),$.fn.tree.parseOptions(_bb3));
};
...
(function($){
function _bb4(_bb5){
var _bb6=$.data(_bb5,"combogrid");
var opts=_bb6.options;
var grid=_bb6.grid;
$(_bb5).addClass("combogrid-f").combo($.extend({},opts,{onShowPanel:function(){
_bcd(this,$(this).combogrid("getValues"),true);
var p=$(this).combogrid("panel");
var _bb7=p.outerHeight()-p.height();
var _bb8=p._size("minHeight");
var _bb9=p._size("maxHeight");
var dg=$(this).combogrid("grid");
dg.datagrid("resize",{width:"100%",height:(isNaN(parseInt(opts.panelHeight))?"auto":"100%"),minHeight:(_bb8?_bb8-_bb7:""),maxHeight:(_bb9?_bb9-_bb7:"")});
...
var _bba=$(_bb5).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_bba);
_bb6.grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,singleSelect:(!opts.multiple),onLoadSuccess:_bbb,onClickRow:_bbc,onSelect:_bbd("onSelect"),onUnselect:_bbd("onUnselect"),onSelectAll:_bbd("onSelectAll"),onUnselectAll:_bbd("onUnselectAll")}));
function _bbe(dg){
return $(dg).closest(".combo-panel").panel("options").comboTarget||_bb5;
};
function _bbb(data){
var _bbf=_bbe(this);
var _bc0=$(_bbf).data("combogrid");
var opts=_bc0.options;
var _bc1=$(_bbf).combo("getValues");
_bcd(_bbf,_bc1,_bc0.remainText);
opts.onLoadSuccess.call(this,data);
};
function _bbc(_bc2,row){
var _bc3=_bbe(this);
var _bc4=$(_bc3).data("combogrid");
var opts=_bc4.options;
_bc4.remainText=false;
_bc5.call(this);
if(!opts.multiple){
$(_bc3).combo("hidePanel");
}
opts.onClickRow.call(this,_bc2,row);
};
function _bbd(_bc6){
return function(_bc7,row){
var _bc8=_bbe(this);
var opts=$(_bc8).combogrid("options");
if(_bc6=="onUnselectAll"){
if(opts.multiple){
_bc5.call(this);
}
}else{
...
opts[_bc6].call(this,_bc7,row);
};
};
function _bc5(){
var dg=$(this);
var _bc9=_bbe(dg);
var _bca=$(_bc9).data("combogrid");
var opts=_bca.options;
var vv=$.map(dg.datagrid("getSelections"),function(row){
return row[opts.idField];
});
vv=vv.concat(opts.unselectedValues);
var _bcb=dg.data("datagrid").dc.body2;
var _bcc=_bcb.scrollTop();
_bcd(_bc9,vv,_bca.remainText);
_bcb.scrollTop(_bcc);
};
};
function nav(_bce,dir){
var _bcf=$.data(_bce,"combogrid");
var opts=_bcf.options;
var grid=_bcf.grid;
var _bd0=grid.datagrid("getRows").length;
if(!_bd0){
return;
}
...
var _bd1;
if(!tr.length){
_bd1=(dir=="next"?0:_bd0-1);
}else{
var _bd1=parseInt(tr.attr("datagrid-row-index"));
_bd1+=(dir=="next"?1:-1);
if(_bd1<0){
_bd1=_bd0-1;
}
...
grid.datagrid("highlightRow",_bd1);
if(opts.selectOnNavigation){
_bcf.remainText=false;
grid.datagrid("selectRow",_bd1);
}
};
function _bcd(_bd2,_bd3,_bd4){
var _bd5=$.data(_bd2,"combogrid");
var opts=_bd5.options;
var grid=_bd5.grid;
var _bd6=$(_bd2).combo("getValues");
var _bd7=$(_bd2).combo("options");
var _bd8=_bd7.onChange;
_bd7.onChange=function(){
};
var _bd9=grid.datagrid("options");
var _bda=_bd9.onSelect;
var _bdb=_bd9.onUnselectAll;
_bd9.onSelect=_bd9.onUnselectAll=function(){
};
if(!$.isArray(_bd3)){
_bd3=_bd3.split(opts.separator);
}
if(!opts.multiple){
_bd3=_bd3.length?[_bd3[0]]:[""];
}
var vv=$.map(_bd3,function(_bdc){
return String(_bdc);
});
vv=$.grep(vv,function(v,_bdd){
return _bdd===$.inArray(v,vv);
});
var _bde=$.grep(grid.datagrid("getSelections"),function(row,_bdf){
return $.inArray(String(row[opts.idField]),vv)>=0;
});
grid.datagrid("clearSelections");
grid.data("datagrid").selectedRows=_bde;
var ss=[];
opts.unselectedValues=[];
$.map(vv,function(v){
var _be0=grid.datagrid("getRowIndex",v);
if(_be0>=0){
grid.datagrid("selectRow",_be0);
}else{
opts.unselectedValues.push(v);
}
ss.push(_be1(v,grid.datagrid("getRows"))||_be1(v,_bde)||_be1(v,opts.mappingRows)||v);
});
$(_bd2).combo("setValues",_bd6);
_bd7.onChange=_bd8;
_bd9.onSelect=_bda;
_bd9.onUnselectAll=_bdb;
if(!_bd4){
var s=ss.join(opts.separator);
if($(_bd2).combo("getText")!=s){
$(_bd2).combo("setText",s);
}
}
$(_bd2).combo("setValues",_bd3);
function _be1(_be2,a){
var item=$.easyui.getArrayItem(a,opts.idField,_be2);
return item?item[opts.textField]:undefined;
};
};
function _be3(_be4,q){
var _be5=$.data(_be4,"combogrid");
var opts=_be5.options;
var grid=_be5.grid;
_be5.remainText=true;
var qq=opts.multiple?q.split(opts.separator):[q];
...
q=$.trim(q);
var _be7=q;
_be8(opts.mappingRows,q);
_be8(grid.datagrid("getSelections"),q);
var _be9=_be8(rows,q);
if(_be9>=0){
if(opts.reversed){
grid.datagrid("highlightRow",_be9);
}
}else{
$.map(rows,function(row,i){
if(opts.filter.call(_be4,q,row)){
...
var grid=_bec.grid;
var tr=opts.finder.getTr(grid[0],null,"highlight");
_bec.remainText=false;
if(tr.length){
var _bed=parseInt(tr.attr("datagrid-row-index"));
if(opts.multiple){
if(tr.hasClass("datagrid-row-selected")){
grid.datagrid("unselectRow",_bed);
}else{
...
$(_beb).combogrid("setValues",vv);
if(!opts.multiple){
$(_beb).combogrid("hidePanel");
}
};
$.fn.combogrid=function(_bee,_bef){
if(typeof _bee=="string"){
var _bf0=$.fn.combogrid.methods[_bee];
if(_bf0){
return _bf0(this,_bef);
}else{
return this.combo(_bee,_bef);
}
}
_bee=_bee||{};
return this.each(function(){
var _bf1=$.data(this,"combogrid");
if(_bf1){
$.extend(_bf1.options,_bee);
}else{
_bf1=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_bee)});
}
_bb4(this);
});
};
$.fn.combogrid.methods={options:function(jq){
var _bf2=jq.combo("options");
return $.extend($.data(jq[0],"combogrid").options,{width:_bf2.width,height:_bf2.height,originalValue:_bf2.originalValue,disabled:_bf2.disabled,readonly:_bf2.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
$(this).combo("cloneFrom",from);
...
},setValues:function(jq,_bf3){
return jq.each(function(){
var opts=$(this).combogrid("options");
if($.isArray(_bf3)){
_bf3=$.map(_bf3,function(_bf4){
if(_bf4&&typeof _bf4=="object"){
$.easyui.addArrayItem(opts.mappingRows,opts.idField,_bf4);
return _bf4[opts.idField];
}else{
return _bf4;
}
});
...
},setValue:function(jq,_bf5){
return jq.each(function(){
$(this).combogrid("setValues",$.isArray(_bf5)?_bf5:[_bf5]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combogrid.parseOptions=function(_bf6){
var t=$(_bf6);
return $.extend({},$.fn.combo.parseOptions(_bf6),$.fn.datagrid.parseOptions(_bf6),$.parser.parseOptions(_bf6,["idField","textField","mode"]));
};
...
$.fn.combo.defaults.inputEvents.blur(e);
var _bf7=e.data.target;
var opts=$(_bf7).combogrid("options");
if(opts.reversed){
$(_bf7).combogrid("setValues",$(_bf7).combogrid("getValues"));
}
...
(function($){
function _bf8(_bf9){
var _bfa=$.data(_bf9,"combotreegrid");
var opts=_bfa.options;
$(_bf9).addClass("combotreegrid-f").combo($.extend({},opts,{onShowPanel:function(){
var p=$(this).combotreegrid("panel");
var _bfb=p.outerHeight()-p.height();
var _bfc=p._size("minHeight");
var _bfd=p._size("maxHeight");
var dg=$(this).combotreegrid("grid");
dg.treegrid("resize",{width:"100%",height:(isNaN(parseInt(opts.panelHeight))?"auto":"100%"),minHeight:(_bfc?_bfc-_bfb:""),maxHeight:(_bfd?_bfd-_bfb:"")});
...
if(!_bfa.grid){
var _bfe=$(_bf9).combo("panel");
_bfa.grid=$("<table></table>").appendTo(_bfe);
}
_bfa.grid.treegrid($.extend({},opts,{border:false,checkbox:opts.multiple,onLoadSuccess:function(row,data){
var _bff=$(_bf9).combotreegrid("getValues");
if(opts.multiple){
$.map($(this).treegrid("getCheckedNodes"),function(row){
$.easyui.addArrayItem(_bff,row[opts.idField]);
});
}
_c04(_bf9,_bff);
opts.onLoadSuccess.call(this,row,data);
_bfa.remainText=false;
},onClickRow:function(row){
if(opts.multiple){
$(this).treegrid(row.checked?"uncheckNode":"checkNode",row[opts.idField]);
$(this).treegrid("unselect",row[opts.idField]);
}else{
$(_bf9).combo("hidePanel");
}
_c01(_bf9);
opts.onClickRow.call(this,row);
},onCheckNode:function(row,_c00){
_c01(_bf9);
opts.onCheckNode.call(this,row,_c00);
}}));
};
function _c01(_c02){
...
var _c07=$.data(_c05,"combotreegrid");
var opts=_c07.options;
var grid=_c07.grid;
if(!$.isArray(_c06)){
_c06=_c06.split(opts.separator);
}
if(!opts.multiple){
_c06=_c06.length?[_c06[0]]:[""];
}
var vv=$.map(_c06,function(_c08){
return String(_c08);
});
vv=$.grep(vv,function(v,_c09){
return _c09===$.inArray(v,vv);
});
var _c0a=grid.treegrid("getSelected");
if(_c0a){
grid.treegrid("unselect",_c0a[opts.idField]);
}
...
ss.push(_c0c(v,opts.mappingRows)||v);
opts.unselectedValues.push(v);
}
});
if(opts.multiple){
...
if(!_c07.remainText){
var s=ss.join(opts.separator);
if($(_c05).combo("getText")!=s){
$(_c05).combo("setText",s);
}
}
$(_c05).combo("setValues",vv);
function _c0c(_c0d,a){
var item=$.easyui.getArrayItem(a,opts.idField,_c0d);
return item?_c0b(item):undefined;
};
function _c0b(row){
...
if(opts.filter.call(_c0f,q,row)){
...
function _c11(vv){
if(!opts.reversed){
$(_c0f).combotreegrid("setValues",vv);
}
};
};
function _c12(_c13){
var _c14=$.data(_c13,"combotreegrid");
var opts=_c14.options;
var grid=_c14.grid;
var tr=opts.finder.getTr(grid[0],null,"highlight");
_c14.remainText=false;
if(tr.length){
...
$(_c13).combotreegrid("setValues",vv);
if(!opts.multiple){
$(_c13).combotreegrid("hidePanel");
}
};
$.fn.combotreegrid=function(_c15,_c16){
if(typeof _c15=="string"){
var _c17=$.fn.combotreegrid.methods[_c15];
if(_c17){
return _c17(this,_c16);
}else{
return this.combo(_c15,_c16);
}
}
_c15=_c15||{};
return this.each(function(){
var _c18=$.data(this,"combotreegrid");
if(_c18){
$.extend(_c18.options,_c15);
}else{
_c18=$.data(this,"combotreegrid",{options:$.extend({},$.fn.combotreegrid.defaults,$.fn.combotreegrid.parseOptions(this),_c15)});
}
_bf8(this);
});
};
$.fn.combotreegrid.methods={options:function(jq){
var _c19=jq.combo("options");
return $.extend($.data(jq[0],"combotreegrid").options,{width:_c19.width,height:_c19.height,originalValue:_c19.originalValue,disabled:_c19.disabled,readonly:_c19.readonly});
},grid:function(jq){
return $.data(jq[0],"combotreegrid").grid;
},setValues:function(jq,_c1a){
return jq.each(function(){
var opts=$(this).combotreegrid("options");
if($.isArray(_c1a)){
_c1a=$.map(_c1a,function(_c1b){
if(_c1b&&typeof _c1b=="object"){
$.easyui.addArrayItem(opts.mappingRows,opts.idField,_c1b);
return _c1b[opts.idField];
}else{
return _c1b;
}
});
...
},setValue:function(jq,_c1c){
return jq.each(function(){
$(this).combotreegrid("setValues",$.isArray(_c1c)?_c1c:[_c1c]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combotreegrid.parseOptions=function(_c1d){
var t=$(_c1d);
return $.extend({},$.fn.combo.parseOptions(_c1d),$.fn.treegrid.parseOptions(_c1d),$.parser.parseOptions(_c1d,["mode",{limitToGrid:"boolean"}]));
};
...
$.fn.combo.defaults.inputEvents.blur(e);
var _c1e=e.data.target;
var opts=$(_c1e).combotreegrid("options");
if(opts.limitToGrid){
_c12(_c1e);
}
}}),filter:function(q,row){
...
(function($){
function _c1f(_c20){
var _c21=$.data(_c20,"tagbox");
var opts=_c21.options;
$(_c20).addClass("tagbox-f").combobox($.extend({},opts,{cls:"tagbox",reversed:true,onChange:function(_c22,_c23){
_c24();
$(this).combobox("hidePanel");
opts.onChange.call(_c20,_c22,_c23);
},onResizing:function(_c25,_c26){
var _c27=$(this).combobox("textbox");
var tb=$(this).data("textbox").textbox;
var _c28=tb.outerWidth();
tb.css({height:"",paddingLeft:_c27.css("marginLeft"),paddingRight:_c27.css("marginRight")});
_c27.css("margin",0);
tb._outerWidth(_c28);
_c3b(_c20);
_c2d(this);
opts.onResizing.call(_c20,_c25,_c26);
},onLoadSuccess:function(data){
_c24();
opts.onLoadSuccess.call(_c20,data);
}}));
_c24();
_c3b(_c20);
function _c24(){
$(_c20).next().find(".tagbox-label").remove();
var _c29=$(_c20).tagbox("textbox");
var ss=[];
$.map($(_c20).tagbox("getValues"),function(_c2a,_c2b){
var row=opts.finder.getRow(_c20,_c2a);
var text=opts.tagFormatter.call(_c20,_c2a,row);
var cs={};
var css=opts.tagStyler.call(_c20,_c2a,row)||"";
if(typeof css=="string"){
cs={s:css};
}else{
cs={c:css["class"]||"",s:css["style"]||""};
}
var _c2c=$("<span class=\"tagbox-label\"></span>").insertBefore(_c29).html(text);
_c2c.attr("tagbox-index",_c2b);
_c2c.attr("style",cs.s).addClass(cs.c);
$("<a href=\"javascript:;\" class=\"tagbox-remove\"></a>").appendTo(_c2c);
});
_c2d(_c20);
$(_c20).combobox("setText","");
};
};
function _c2d(_c2e,_c2f){
var span=$(_c2e).next();
var _c30=_c2f?$(_c2f):span.find(".tagbox-label");
if(_c30.length){
var _c31=$(_c2e).tagbox("textbox");
var _c32=$(_c30[0]);
var _c33=_c32.outerHeight(true)-_c32.outerHeight();
var _c34=_c31.outerHeight()-_c33*2;
_c30.css({height:_c34+"px",lineHeight:_c34+"px"});
var _c35=span.find(".textbox-addon").css("height","100%");
_c35.find(".textbox-icon").css("height","100%");
...
var opts=$(_c37).tagbox("options");
if(opts.disabled||opts.readonly){
return;
}
if($(e.target).hasClass("tagbox-remove")){
var _c38=parseInt($(e.target).parent().attr("tagbox-index"));
var _c39=$(_c37).tagbox("getValues");
if(opts.onBeforeRemoveTag.call(_c37,_c39[_c38])==false){
return;
}
opts.onRemoveTag.call(_c37,_c39[_c38]);
_c39.splice(_c38,1);
$(_c37).tagbox("setValues",_c39);
}else{
var _c3a=$(e.target).closest(".tagbox-label");
if(_c3a.length){
var _c38=parseInt(_c3a.attr("tagbox-index"));
var _c39=$(_c37).tagbox("getValues");
opts.onClickTag.call(_c37,_c39[_c38]);
}
}
...
var _c3d=$(_c3c).tagbox("textbox");
var span=$(_c3c).next();
var tmp=$("<span></span>").appendTo("body");
tmp.attr("style",_c3d.attr("style"));
tmp.css({position:"absolute",top:-9999,left:-9999,width:"auto",fontFamily:_c3d.css("fontFamily"),fontSize:_c3d.css("fontSize"),fontWeight:_c3d.css("fontWeight"),whiteSpace:"nowrap"});
var _c3e=_c3f(_c3d.val());
var _c40=_c3f(opts.prompt||"");
tmp.remove();
var _c41=Math.min(Math.max(_c3e,_c40)+20,span.width());
_c3d._outerWidth(_c41);
span.find(".textbox-button").linkbutton("resize",{height:"100%"});
function _c3f(val){
...
if(opts.limitToList){
var _c44=t.tagbox("panel");
var item=_c44.children("div.combobox-item-hover");
if(item.length){
item.removeClass("combobox-item-hover");
var row=opts.finder.getRow(_c43,item);
var _c45=row[opts.valueField];
$(_c43).tagbox(item.hasClass("combobox-item-selected")?"unselect":"select",_c45);
}
$(_c43).tagbox("hidePanel");
}else{
var v=$.trim($(_c43).tagbox("getText"));
if(v!==""){
var _c46=$(_c43).tagbox("getValues");
_c46.push(v);
$(_c43).tagbox("setValues",_c46);
}
}
};
function _c47(_c48,_c49){
$(_c48).combobox("setText","");
_c3b(_c48);
$(_c48).combobox("setValues",_c49);
$(_c48).combobox("setText","");
$(_c48).tagbox("validate");
};
$.fn.tagbox=function(_c4a,_c4b){
if(typeof _c4a=="string"){
var _c4c=$.fn.tagbox.methods[_c4a];
if(_c4c){
return _c4c(this,_c4b);
}else{
return this.combobox(_c4a,_c4b);
}
}
_c4a=_c4a||{};
return this.each(function(){
var _c4d=$.data(this,"tagbox");
if(_c4d){
$.extend(_c4d.options,_c4a);
}else{
$.data(this,"tagbox",{options:$.extend({},$.fn.tagbox.defaults,$.fn.tagbox.parseOptions(this),_c4a)});
}
_c1f(this);
_c36(this);
});
...
var _c4e=jq.combobox("options");
return $.extend($.data(jq[0],"tagbox").options,{width:_c4e.width,height:_c4e.height,originalValue:_c4e.originalValue,disabled:_c4e.disabled,readonly:_c4e.readonly});
},setValues:function(jq,_c4f){
return jq.each(function(){
_c47(this,_c4f);
});
},reset:function(jq){
...
$.fn.tagbox.parseOptions=function(_c50){
return $.extend({},$.fn.combobox.parseOptions(_c50),$.parser.parseOptions(_c50,[]));
};
$.fn.tagbox.defaults=$.extend({},$.fn.combobox.defaults,{hasDownArrow:false,multiple:true,reversed:true,selectOnNavigation:false,tipOptions:$.extend({},$.fn.textbox.defaults.tipOptions,{showDelay:200}),val:function(_c51){
var vv=$(_c51).parent().prev().tagbox("getValues");
if($(_c51).is(":focus")){
vv.push($(_c51).val());
}
return vv.join(",");
...
}}),tagFormatter:function(_c53,row){
var opts=$(this).tagbox("options");
return row?row[opts.textField]:_c53;
},tagStyler:function(_c54,row){
return "";
},onClickTag:function(_c55){
},onBeforeRemoveTag:function(_c56){
},onRemoveTag:function(_c57){
}});
})(jQuery);
(function($){
function _c58(_c59){
var _c5a=$.data(_c59,"datebox");
var opts=_c5a.options;
$(_c59).addClass("datebox-f").combo($.extend({},opts,{onShowPanel:function(){
_c5b(this);
_c5c(this);
_c5d(this);
_c6b(this,$(this).datebox("getText"),true);
opts.onShowPanel.call(this);
}}));
if(!_c5a.calendar){
var _c5e=$(_c59).combo("panel").css("overflow","hidden");
_c5e.panel("options").onBeforeDestroy=function(){
var c=$(this).find(".calendar-shared");
if(c.length){
c.insertBefore(c[0].pholder);
}
};
var cc=$("<div class=\"datebox-calendar-inner\"></div>").prependTo(_c5e);
...
_c5a.calendar=$("<div></div>").appendTo(cc).calendar();
}
$.extend(_c5a.calendar.calendar("options"),{fit:true,border:false,onSelect:function(date){
var _c5f=this.target;
var opts=$(_c5f).datebox("options");
opts.onSelect.call(_c5f,date);
_c6b(_c5f,opts.formatter.call(_c5f,date));
$(_c5f).combo("hidePanel");
}});
}
$(_c59).combo("textbox").parent().addClass("datebox");
$(_c59).datebox("initValue",opts.value);
function _c5b(_c60){
var opts=$(_c60).datebox("options");
var _c61=$(_c60).combo("panel");
_c61.unbind(".datebox").bind("click.datebox",function(e){
if($(e.target).hasClass("datebox-button-a")){
var _c62=parseInt($(e.target).attr("datebox-button-index"));
opts.buttons[_c62].handler.call(e.target,_c60);
}
});
};
function _c5c(_c63){
var _c64=$(_c63).combo("panel");
if(_c64.children("div.datebox-button").length){
return;
}
var _c65=$("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>").appendTo(_c64);
var tr=_c65.find("tr");
for(var i=0;i<opts.buttons.length;i++){
var td=$("<td></td>").appendTo(tr);
var btn=opts.buttons[i];
var t=$("<a class=\"datebox-button-a\" href=\"javascript:;\"></a>").html($.isFunction(btn.text)?btn.text(_c63):btn.text).appendTo(td);
...
var cc=_c67.children("div.datebox-calendar-inner");
_c67.children()._outerWidth(_c67.width());
_c5a.calendar.appendTo(cc);
_c5a.calendar[0].target=_c66;
if(opts.panelHeight!="auto"){
var _c68=_c67.height();
_c67.children().not(cc).each(function(){
_c68-=$(this).outerHeight();
});
cc._outerHeight(_c68);
}
_c5a.calendar.calendar("resize");
};
};
function _c69(_c6a,q){
_c6b(_c6a,q,true);
};
function _c6c(_c6d){
var _c6e=$.data(_c6d,"datebox");
var opts=_c6e.options;
var _c6f=_c6e.calendar.calendar("options").current;
if(_c6f){
_c6b(_c6d,opts.formatter.call(_c6d,_c6f));
$(_c6d).combo("hidePanel");
}
};
function _c6b(_c70,_c71,_c72){
var _c73=$.data(_c70,"datebox");
var opts=_c73.options;
var _c74=_c73.calendar;
_c74.calendar("moveTo",opts.parser.call(_c70,_c71));
if(_c72){
$(_c70).combo("setValue",_c71);
}else{
if(_c71){
_c71=opts.formatter.call(_c70,_c74.calendar("options").current);
}
$(_c70).combo("setText",_c71).combo("setValue",_c71);
}
};
$.fn.datebox=function(_c75,_c76){
if(typeof _c75=="string"){
var _c77=$.fn.datebox.methods[_c75];
if(_c77){
...
_c75=_c75||{};
return this.each(function(){
var _c78=$.data(this,"datebox");
if(_c78){
$.extend(_c78.options,_c75);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_c75)});
}
_c58(this);
});
};
...
return $.extend($.data(jq[0],"datebox").options,{width:_c79.width,height:_c79.height,originalValue:_c79.originalValue,disabled:_c79.disabled,readonly:_c79.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
$(this).combo("cloneFrom",from);
...
},initValue:function(jq,_c7a){
return jq.each(function(){
var opts=$(this).datebox("options");
var _c7b=opts.value;
if(_c7b){
_c7b=opts.formatter.call(this,opts.parser.call(this,_c7b));
}
$(this).combo("initValue",_c7b).combo("setText",_c7b);
});
},setValue:function(jq,_c7c){
return jq.each(function(){
_c6b(this,_c7c);
});
},reset:function(jq){
...
$.fn.datebox.parseOptions=function(_c7d){
return $.extend({},$.fn.combo.parseOptions(_c7d),$.parser.parseOptions(_c7d,["sharedCalendar"]));
};
...
_c69(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",buttons:[{text:function(_c7e){
return $(_c7e).datebox("options").currentText;
},handler:function(_c7f){
var opts=$(_c7f).datebox("options");
var now=new Date();
var _c80=new Date(now.getFullYear(),now.getMonth(),now.getDate());
$(_c7f).datebox("calendar").calendar({year:_c80.getFullYear(),month:_c80.getMonth()+1,current:_c80});
opts.onSelect.call(_c7f,_c80);
_c6c(_c7f);
}},{text:function(_c81){
return $(_c81).datebox("options").closeText;
...
(function($){
function _c83(_c84){
var _c85=$.data(_c84,"datetimebox");
var opts=_c85.options;
$(_c84).datebox($.extend({},opts,{onShowPanel:function(){
var _c86=$(this).datetimebox("getValue");
_c8c(this,_c86,true);
opts.onShowPanel.call(this);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_c84).removeClass("datebox-f").addClass("datetimebox-f");
$(_c84).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(this.target,date);
}});
if(!_c85.spinner){
var _c87=$(_c84).datebox("panel");
var p=$("<div style=\"padding:2px\"><input></div>").insertAfter(_c87.children("div.datebox-calendar-inner"));
_c85.spinner=p.children("input");
}
_c85.spinner.timespinner({width:opts.spinnerWidth,showSeconds:opts.showSeconds,separator:opts.timeSeparator,hour12:opts.hour12});
$(_c84).datetimebox("initValue",opts.value);
};
function _c88(_c89){
var c=$(_c89).datetimebox("calendar");
var t=$(_c89).datetimebox("spinner");
...
var date=_c88(_c8e);
_c8c(_c8e,opts.formatter.call(_c8e,date));
$(_c8e).combo("hidePanel");
};
function _c8c(_c8f,_c90,_c91){
var opts=$.data(_c8f,"datetimebox").options;
$(_c8f).combo("setValue",_c90);
if(!_c91){
if(_c90){
var date=opts.parser.call(_c8f,_c90);
$(_c8f).combo("setText",opts.formatter.call(_c8f,date));
$(_c8f).combo("setValue",opts.formatter.call(_c8f,date));
}else{
$(_c8f).combo("setText",_c90);
}
}
var date=opts.parser.call(_c8f,_c90);
$(_c8f).datetimebox("calendar").calendar("moveTo",date);
$(_c8f).datetimebox("spinner").timespinner("setValue",_c92(date));
function _c92(date){
function _c93(_c94){
return (_c94<10?"0":"")+_c94;
};
var tt=[_c93(date.getHours()),_c93(date.getMinutes())];
if(opts.showSeconds){
tt.push(_c93(date.getSeconds()));
}
return tt.join($(_c8f).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_c95,_c96){
if(typeof _c95=="string"){
var _c97=$.fn.datetimebox.methods[_c95];
if(_c97){
return _c97(this,_c96);
}else{
return this.datebox(_c95,_c96);
}
}
_c95=_c95||{};
return this.each(function(){
var _c98=$.data(this,"datetimebox");
if(_c98){
$.extend(_c98.options,_c95);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_c95)});
}
_c83(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _c99=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_c99.originalValue,disabled:_c99.disabled,readonly:_c99.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},initValue:function(jq,_c9a){
return jq.each(function(){
var opts=$(this).datetimebox("options");
var _c9b=opts.value;
if(_c9b){
_c9b=opts.formatter.call(this,opts.parser.call(this,_c9b));
}
$(this).combo("initValue",_c9b).combo("setText",_c9b);
});
},setValue:function(jq,_c9c){
return jq.each(function(){
_c8c(this,_c9c);
});
},reset:function(jq){
...
$.fn.datetimebox.parseOptions=function(_c9d){
var t=$(_c9d);
return $.extend({},$.fn.datebox.parseOptions(_c9d),$.parser.parseOptions(_c9d,["timeSeparator","spinnerWidth",{showSeconds:"boolean"}]));
};
...
_c8a(this,q);
}},buttons:[{text:function(_c9e){
return $(_c9e).datetimebox("options").currentText;
},handler:function(_c9f){
var opts=$(_c9f).datetimebox("options");
_c8c(_c9f,opts.formatter.call(_c9f,new Date()));
$(_c9f).datetimebox("hidePanel");
}},{text:function(_ca0){
return $(_ca0).datetimebox("options").okText;
},handler:function(_ca1){
_c8d(_ca1);
}},{text:function(_ca2){
return $(_ca2).datetimebox("options").closeText;
},handler:function(_ca3){
$(_ca3).datetimebox("hidePanel");
}}],formatter:function(date){
if(!date){
return "";
}
...
var dt=s.split(" ");
var _ca4=$.fn.datebox.defaults.parser.call(this,dt[0]);
if(dt.length<2){
return _ca4;
}
var _ca5=$.fn.timespinner.defaults.parser.call($(this).datetimebox("spinner")[0],dt[1]+(dt[2]?" "+dt[2]:""));
return new Date(_ca4.getFullYear(),_ca4.getMonth(),_ca4.getDate(),_ca5.getHours(),_ca5.getMinutes(),_ca5.getSeconds());
}});
})(jQuery);
(function($){
function init(_ca6){
var _ca7=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_ca6);
var t=$(_ca6);
t.addClass("slider-f").hide();
var name=t.attr("name");
if(name){
_ca7.find("input.slider-value").attr("name",name);
t.removeAttr("name").attr("sliderName",name);
}
_ca7.bind("_resize",function(e,_ca8){
if($(this).hasClass("easyui-fluid")||_ca8){
_ca9(_ca6);
}
return false;
});
...
var _cac=$.data(_caa,"slider");
var opts=_cac.options;
var _cad=_cac.slider;
if(_cab){
if(_cab.width){
opts.width=_cab.width;
}
if(_cab.height){
opts.height=_cab.height;
}
}
_cad._size(opts);
if(opts.mode=="h"){
_cad.css("height","");
_cad.children("div").css("height","");
}else{
_cad.css("width","");
_cad.children("div").css("width","");
_cad.children("div.slider-rule,div.slider-rulelabel,div.slider-inner")._outerHeight(_cad._outerHeight());
}
_cae(_caa);
};
function _caf(_cb0){
...
_cb3(aa);
function _cb3(aa){
var rule=_cb2.find("div.slider-rule");
var _cb4=_cb2.find("div.slider-rulelabel");
rule.empty();
_cb4.empty();
for(var i=0;i<aa.length;i++){
var _cb5=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_cb5);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_cb4);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_cb5,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_cb5,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
_cb9.removeClass("slider-h slider-v slider-disabled");
_cb9.addClass(opts.mode=="h"?"slider-h":"slider-v");
_cb9.addClass(opts.disabled?"slider-disabled":"");
var _cba=_cb9.find(".slider-inner");
_cba.html("<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
if(opts.range){
_cba.append("<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
}
_cb9.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
_cb8.isDragging=true;
opts.onSlideStart.call(_cb7,opts.value);
},onStopDrag:function(e){
_cbc(opts.mode=="h"?e.data.left:e.data.top,this);
opts.onSlideEnd.call(_cb7,opts.value);
opts.onComplete.call(_cb7,opts.value);
_cb8.isDragging=false;
}});
_cb9.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",function(e){
if(_cb8.isDragging||opts.disabled){
return;
}
var pos=$(this).offset();
_cbc(opts.mode=="h"?(e.pageX-pos.left):(e.pageY-pos.top));
opts.onComplete.call(_cb7,opts.value);
});
function _cbd(_cbe){
var dd=String(opts.step).split(".");
var dlen=dd.length>1?dd[1].length:0;
return parseFloat(_cbe.toFixed(dlen));
};
function _cbc(pos,_cbf){
var _cc0=_cc1(_cb7,pos);
var s=Math.abs(_cc0%opts.step);
if(s<opts.step/2){
_cc0-=s;
}else{
_cc0=_cc0-s+opts.step;
}
_cc0=_cbd(_cc0);
if(opts.range){
var v1=opts.value[0];
...
if(_cbf){
var _cc2=$(_cbf).nextAll(".slider-handle").length>0;
if(_cc0<=v2&&_cc2){
v1=_cc0;
}else{
if(_cc0>=v1&&(!_cc2)){
...
_cc0<m?v1=_cc0:v2=_cc0;
}
}
}
$(_cb7).slider("setValues",[v1,v2]);
}else{
$(_cb7).slider("setValue",_cc0);
}
};
};
...
var _cc8=$.isArray(opts.value)?opts.value:[opts.value];
var _cc9=[];
if(!$.isArray(_cc5)){
_cc5=$.map(String(_cc5).split(opts.separator),function(v){
return parseFloat(v);
});
}
_cc7.find(".slider-value").remove();
var name=$(_cc4).attr("sliderName")||"";
...
var _ccb=$("<input type=\"hidden\" class=\"slider-value\">").appendTo(_cc7);
_ccb.attr("name",name);
_ccb.val(_cca);
_cc9.push(_cca);
var _ccc=_cc7.find(".slider-handle:eq("+i+")");
var tip=_ccc.next();
var pos=_ccd(_cc4,_cca);
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_cc4,_cca));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _cce="left:"+pos+"px;";
_ccc.attr("style",_cce);
tip.attr("style",_cce+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _cce="top:"+pos+"px;";
_ccc.attr("style",_cce);
tip.attr("style",_cce+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
}
opts.value=opts.range?_cc9:_cc9[0];
$(_cc4).val(opts.range?_cc9.join(opts.separator):_cc9[0]);
if(_cc8.join(",")!=_cc9.join(",")){
opts.onChange.call(_cc4,opts.value,(opts.range?_cc8:_cc8[0]));
}
};
function _cae(_ccf){
var opts=$.data(_ccf,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_cc3(_ccf,opts.value);
opts.onChange=fn;
};
function _ccd(_cd0,_cd1){
var _cd2=$.data(_cd0,"slider");
var opts=_cd2.options;
var _cd3=_cd2.slider;
var size=opts.mode=="h"?_cd3.width():_cd3.height();
var pos=opts.converter.toPosition.call(_cd0,_cd1,size);
if(opts.mode=="v"){
pos=_cd3.height()-pos;
}
if(opts.reversed){
...
function _cc1(_cd4,pos){
var _cd5=$.data(_cd4,"slider");
var opts=_cd5.options;
var _cd6=_cd5.slider;
var size=opts.mode=="h"?_cd6.width():_cd6.height();
var pos=opts.mode=="h"?(opts.reversed?(size-pos):pos):(opts.reversed?pos:(size-pos));
var _cd7=opts.converter.toValue.call(_cd4,pos,size);
return _cd7;
};
$.fn.slider=function(_cd8,_cd9){
if(typeof _cd8=="string"){
return $.fn.slider.methods[_cd8](this,_cd9);
}
_cd8=_cd8||{};
return this.each(function(){
var _cda=$.data(this,"slider");
if(_cda){
$.extend(_cda.options,_cd8);
}else{
_cda=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_cd8),slider:init(this)});
$(this)._propAttr("disabled",false);
}
...
return jq.slider("options").value;
},setValue:function(jq,_cdc){
return jq.each(function(){
_cc3(this,[_cdc]);
});
},setValues:function(jq,_cdd){
return jq.each(function(){
_cc3(this,_cdd);
});
},clear:function(jq){
...
_cc3(this,opts.range?[opts.min,opts.max]:[opts.min]);
});
},reset:function(jq){
return jq.each(function(){
var opts=$(this).slider("options");
...
$.fn.slider.parseOptions=function(_cde){
var t=$(_cde);
return $.extend({},$.parser.parseOptions(_cde,["width","height","mode",{reversed:"boolean",showTip:"boolean",range:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,range:false,value:0,separator:",",min:0,max:100,step:1,rule:[],tipFormatter:function(_cdf){
return _cdf;
},converter:{toPosition:function(_ce0,size){
var opts=$(this).slider("options");
var p=(_ce0-opts.min)/(opts.max-opts.min)*size;
return p;
},toValue:function(pos,size){
var opts=$(this).slider("options");
var v=opts.min+(opts.max-opts.min)*(pos/size);
return v;
}},onChange:function(_ce1,_ce2){
},onSlideStart:function(_ce3){
},onSlideEnd:function(_ce4){
},onComplete:function(_ce5){
}};
})(jQuery);
